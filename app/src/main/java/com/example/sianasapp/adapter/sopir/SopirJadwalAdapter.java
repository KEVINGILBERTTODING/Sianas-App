...
public class SopirJadwalAdapter extends RecyclerView.Adapter<SopirJadwalAdapter.ViewHolder> {
    Context context;
    List<RiwayatModel> riwayatModelList;
    private AlertDialog progressDialog;
    private AdminService adminService;

    public SopirJadwalAdapter(Context context, List<RiwayatModel> riwayatModelList) {
    ...
    @NonNull
    @Override
    public SopirJadwalAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull SopirJadwalAdapter.ViewHolder holder, int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            Fragment fragment = new SopirJadwalDetailFragment();
